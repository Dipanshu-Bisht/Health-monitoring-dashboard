...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (validate()) {
      const result = await handleSignup(name, email, password, age, gender);
      if (result.success) {
            ...
            <div className="flex items-center border rounded-lg p-2">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth="2"
                  d="M12 4a4 4 0 00-4 4 4 4 0 008 0 4 4 0 00-4-4zm0 10c-3.86 0-7 1.79-7 4v2h14v-2c0-2.21-3.14-4-7-4z"
                />
              </svg>
              <input
                type="text"
